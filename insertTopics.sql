INSERT INTO id4147366_vestapp.topic (topic_name, subject_id) VALUES ('Grupos Animais - Introdução I', (SELECT subject_id FROM id4147366_vestapp.subject WHERE subject_name = 'Biologia'));
INSERT INTO id4147366_vestapp.topic (topic_name, subject_id) VALUES ('Parasitoses - vermes/protozoários', (SELECT subject_id FROM id4147366_vestapp.subject WHERE subject_name = 'Biologia'));
